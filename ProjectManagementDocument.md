...
| 8.3	| 9/14/2016 - 2:00 PM	| Clayton R Samson, Justin A Bougere, Nicholas A Dugal, Sean M Marino, Soh Guo Hao Steffano, Zachary J Robicheaux	| Define activities for each team member to work on and begin designing the data base.	| Nick will work on the sign up page design, Sean will work on the home page design, Clayton will work on class participants design, Zach will design the login screen, Justin will design the course page,
and Steffano will complete the database design.	|
